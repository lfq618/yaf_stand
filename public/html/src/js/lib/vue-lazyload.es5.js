...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
        typeof define === 'function' && define.amd ? define(['es6promise'], factory) :
    ...
    var vueLazyload = (function(Vue, _ref) {
        ...
        var addListener = function addListener(el, binding, vnode) {
            ...
            if (typeof binding.value !== 'string') {
                // try catch 处理图片地址为空报错的问题 KILLER by 2016/11/04 modified
                try {
                    ...
                    imageSrc = Init.error;
                    imageLoading = Init.loading;
                    imageError = Init.error;
                }
            }
